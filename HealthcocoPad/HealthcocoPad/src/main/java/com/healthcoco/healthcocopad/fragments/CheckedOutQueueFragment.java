...
public class CheckedOutQueueFragment extends HealthCocoFragment implements LocalDoInBackgroundListenerOptimised, SwipeRefreshLayout.OnRefreshListener, QueueListitemlistener {
    public static final String INTENT_REFRESH_CHECKED_OUT_QUEUE_DATA = "com.healthcoco.REFRESH_CHECKED_OUT_QUEUE_DATA";
...
//                long selectedMonthInMillis = DateTimeUtil.getLongFromFormattedDayMonthYearFormatString(QueueFragment.DATE_FORMAT_FOR_THIS_SCREEN, DateTimeUtil.getFormattedDateTime(QueueFragment.DATE_FORMAT_FOR_THIS_SCREEN, selectedMonthDayYearInMillis));
    ...
    public void onResume() {
        ...
        if (!receiversRegistered) {
            ...
            filter.addAction(INTENT_REFRESH_CHECKED_OUT_QUEUE_DATA);
