 ...
 * ShimmerFrameLayout}
 */
public class CustomShimmerEffect {
    ...
    public abstract static class Builder<T extends Builder<T>> {
        final CustomShimmerEffect mShimmer = new CustomShimmerEffect();
         ...
         */
        public T copyFrom(CustomShimmerEffect other) {
        ...
        public CustomShimmerEffect build() {
