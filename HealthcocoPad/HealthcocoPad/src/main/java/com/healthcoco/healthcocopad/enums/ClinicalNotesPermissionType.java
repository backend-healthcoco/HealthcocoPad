...
public enum ClinicalNotesPermissionType {
    ...
    PROCEDURES("PROCEDURES", R.string.procedures_treatment_given, R.string.procedures_treatment_given, false, R.layout.layout_item_add_myscript_clinical_note_permision, AutoCompleteTextViewType.PROCEDURES, 35, SuggestionType.PROCEDURES),
