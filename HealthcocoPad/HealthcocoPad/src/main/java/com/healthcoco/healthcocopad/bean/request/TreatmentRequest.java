...
public class TreatmentRequest {
    ...
    private List<TreatmentItemRequest> treatments;
    ...
    public List<TreatmentItemRequest> getTreatments() {
        return treatments;
    }

    public void setTreatments(List<TreatmentItemRequest> treatments) {
