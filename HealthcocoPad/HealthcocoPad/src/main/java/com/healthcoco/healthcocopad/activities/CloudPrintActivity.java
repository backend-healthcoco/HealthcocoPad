...
/**
 * Created by neha on 31/08/16.
 */
public class CloudPrintActivity extends HealthCocoActivity {
    ...
    public static final String DOC_TITLE = "Print";
    ...
    final class PrintDialogJavaScriptInterface {
        ...
        public String getTitle() {
            return cloudPrintIntent.getExtras().getString(TAG_TITLE);
        }
