...
public class SelectedPrescriptionDrugItemsListMyScriptViewHolder extends HealthCocoViewHolder implements View.OnClickListener, CommonListDialogItemClickListener,
    ...
    public SelectedPrescriptionDrugItemsListMyScriptViewHolder(HealthCocoActivity mActivity, AddNewPrescriptionListener addNewPrescriptionListener) {
        super(mActivity);
    ...
    public View getContentView() {
        LinearLayout view = (LinearLayout) inflater.inflate(R.layout.list_item_selected_drug_add_my_script_visits, null);
