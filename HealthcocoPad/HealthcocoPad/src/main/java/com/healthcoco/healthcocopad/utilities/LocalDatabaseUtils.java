...
public class LocalDatabaseUtils {
    ...
    public static final String KEY_PRESENT_COMPLAINT = "present_complaint";
    public static final String KEY_HISTORY_OF_PRESENT_COMPLAINT = "present_complaint_history";
    public static final String KEY_MENSTRUAL_HISTORY = "menstrual_history";
    public static final String KEY_OBSTETRIC_HISTORY = "obstetric_history";
    public static final String KEY_GENERAL_EXAMINATION = "general_exam";
    public static final String KEY_SYSTEMIC_EXAMINATION = "system_exam";
    public static final String KEY_PROVISIONAL_DIAGNOSIS = "provisional_diagnosis";
    public static final String KEY_NOTES = "note";
    public static final String KEY_ECG_DETAILS = "ecg_details";
    public static final String KEY_ECHO = "echo";
    public static final String KEY_X_RAY_DETAILS = "x_ray_details";
    ...
    public static final String KEY_NUTRIENT_CODE = "nutrient_code";
