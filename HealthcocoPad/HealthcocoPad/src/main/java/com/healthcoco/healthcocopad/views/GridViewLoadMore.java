...
public class GridViewLoadMore extends GridView implements AbsListView.OnScrollListener {
    ...
    public GridViewLoadMore(Context context, AttributeSet attrs, int defStyleAttr) {
