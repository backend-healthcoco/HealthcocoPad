...
public class IngredientListSolrViewHolder extends HealthcocoComonRecylcerViewHolder {

    private SelectedRecipeItemClickListener selectedRecipeItemClickListener;
    private HealthCocoActivity mActivity;
    private IngredientResponse objData;
    private TextView tvTitle;
    private TextView tvQuantity;
    private TextView tvCalarie;

    public IngredientListSolrViewHolder(HealthCocoActivity mActivity, View itemView, HealthcocoRecyclerViewItemClickListener itemClickListener, Object listenerObject) {
    ...
    public void applyData(Object object) {
        objData = (IngredientResponse) object;
        if (objData != null) {
