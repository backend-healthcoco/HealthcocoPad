...
public class IndicatorDots extends LinearLayout {
    ...
    public IndicatorDots(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mDotDiameter = (int) typedArray.getDimension(R.styleable.PinLockView_dotDiameter, context.getResources().getDimension(R.dimen.dot_diameter));
            mDotSpacing = (int) typedArray.getDimension(R.styleable.PinLockView_dotSpacing, context.getResources().getDimension(R.dimen.dot_spacing));
