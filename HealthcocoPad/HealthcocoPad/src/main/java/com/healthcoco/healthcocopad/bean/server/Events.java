...
public class Events extends SugarRecord {
    ...
    public static ArrayList<CustomListData> getSectionedDataAppointment(List<Events> list) {
        ArrayList<CustomListData> sksListData = new ArrayList<CustomListData>();
        String currentHeader = "";
        List<Events> headerDataList = null;
        CustomListData currentCustomListData = null;
        if (!Util.isNullOrEmptyList(list)) {
            for (Events appointment : list) {
                ...
                if (!currentHeader.equalsIgnoreCase(formattedCreatedTime)) {
                    ...
                    headerDataList = new ArrayList<Events>();
