...
public enum CommonOpenUpFragmentType {
    ...
    INITIAL_SYNC(0), FEEDBACK(R.string.help_us_to_improve), SYNC_CONTACT(R.string.sync_contact),
    ...
    SETTING_UI_PERMISSION(R.string.ui_permission), SETTING_PRINT(R.string.print), SETTING_KIOSK(R.string.kiosk_setting),
    ...
    SETTINGS_GROUPS(R.string.groups),
    SETTINGS_REFERENCE(R.string.referred_by_settings),
    SETTINGS_DISEASE(R.string.direction),
    SETTINGS_FREQUENCY(R.string.frequency),
    SETTINGS_ABOUT_US(R.string.about_us),
    SETTINGS_DRUG(R.string.drug),
    TEMPLATE_LIST(R.string.templates),
    ...
    ADD_INGREDIENT(R.string.add_ingredient),
    RECIPE_LIST(R.string.recipe_list),
    ADD_RECIPE(R.string.add_recipe),
    ADD_NUTRIENT(R.string.add_nutrient),
    SELECT_INGREDIENT(R.string.select_ingredient),
    ANALYSE(R.string.analyse),
