...
public enum PatientDetailTabType {
    ...
    PATIENT_DETAIL_PRESCRIPTION(4, R.string.prescriptions, R.string.prescriptions, R.drawable.selector_ic_prescription_tab, View.VISIBLE, View.VISIBLE, "PRESCRIPTION"),
    ...
    PATIENT_DETAIL_TREATMENT(6, R.string.treatment, R.string.treatment, R.drawable.selector_ic_treatment_tab, View.VISIBLE, View.VISIBLE, "TREATMENT"),
