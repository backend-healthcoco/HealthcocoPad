...
public enum PatientDetailTabType {
    ...
    PATIENT_DETAIL_INVESTIGATION_NOTES(9, R.string.investigations, R.string.investigations, R.drawable.selector_ic_clinical_notes_tab, View.VISIBLE, View.VISIBLE, "INVESTIGATION_NOTES"),;
