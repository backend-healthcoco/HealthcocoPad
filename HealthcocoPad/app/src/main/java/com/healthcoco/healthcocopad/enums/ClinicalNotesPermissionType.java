...
public enum ClinicalNotesPermissionType {
    ...
    ECG(R.string.ecg_details, false, R.layout.layout_item_add_clinical_note_permision),
    ...
    XRAY(R.string.xray_details, false, R.layout.layout_item_add_clinical_note_permision),
