...
public class HealthCocoConstants {
    ...
    public static final int RESULT_CODE_ADD_EDIT_CLINIC_HOURS = 137;
    public static final int RESULT_CODE_ADD_EDIT_CLINIC_CONTACT = 138;
    public static final int RESULT_CODE_ADD_EDIT_APPOINTMENT_DETAILS = 139;
    public static final int REQUEST_CODE_MY_PROFILE = 140;
    public static final int REQUEST_CODE_MY_CLINIC = 141;
    public static final int RESULT_CODE_REGISTRATION_DETAIL = 142;
    public static final int RESULT_CODE_DOCTOR_PROFILE_CONTACT_DETAIL = 144;
    public static final int RESULT_CODE_DOCTOR_AWARDS_PUBLICATION_DETAIL = 145;
    public static final int RESULT_CODE_DOCTOR_EDUCATION_DETAIL = 146;
    public static final int RESULT_CODE_DOCTOR_REGISTRATION_DETAIL = 147;
    public static final int RESULT_CODE_DOCTOR_EXPERIENCE_DETAIL = 148;
    public static final int RESULT_CODE_DOCTOR_PROFESSIONAL_MEMBERSHIP_DETAIL = 149;
    public static final int RESULT_CODE_DOCTOR_PROFESSIONAL_STATEMENT_DETAIL = 150;
