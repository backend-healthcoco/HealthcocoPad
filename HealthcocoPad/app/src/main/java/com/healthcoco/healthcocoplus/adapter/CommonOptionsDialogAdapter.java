...
import com.healthcoco.healthcocoplus.viewholders.CommonOptionsDialogViewHolder;

import java.util.ArrayList;

public class CommonOptionsDialogAdapter extends BaseAdapter {
    ...
    public CommonOptionsDialogAdapter(HealthCocoActivity mActivity) {
